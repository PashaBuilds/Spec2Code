    ...
    body: (
      <>
        ...
        <P>
          ...
          görünür. Mesaj kataloğunun tek doğruluk kaynağı <M>backend/data/message_catalog.json</M>
          dosyasıdır (op id'ler kalıcı). Ham konsol çıktısı içinse harici bir seri terminal kullan
