...
def _gpio_low_level(module: str, channel_def: str) -> list[CFunc]:
    ...
    wr.ln("/* TRI geri okumasi guvenilmez: \"All Outputs\" kanalinda TRI yoktur,")
    wr.ln(" * sabit 0xFFFFFFFF okunur (SAHA 2026-09-13 Nexys A7); \"All Inputs\"")
    wr.ln(" * kanalinda DATA yazmasi yutulur. Dogrulama DATA geri okumasiyla:")
    wr.ln(" * yazilan deger geri gelmiyorsa pinler surulemiyor demektir. */")
    ...
    wr.ln(f"uiCurrent = ((unsigned int)XGpio_DiscreteRead(spGpio, {channel_def})) & uiMask;")
    wr.open("if (uiCurrent != (uiValue & uiMask))")
