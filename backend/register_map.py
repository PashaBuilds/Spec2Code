...
def generate_header(rmap: dict) -> str:
    ...
    lines.append("")
    lines.append("/* Generated by Spec2Code (register map ureticisi).")
...
def generate_shell_command(rmap: dict) -> str:
    ...
    lines = [
        "/* Generated by Spec2Code (register map ureticisi).",
...
def generate_shell_header(rmap: dict) -> str:
    ...
    return "\n".join([
        ...
        f"#define {guard}",
        "",
        f"/* Shell komutu `ip_{map_name} ...` (bkz. {map_name}_shell.c). Tabloya:",
